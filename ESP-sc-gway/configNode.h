...
#define _DESCRIPTION "Name of the gateway"		              // Name of the gateway
#define _EMAIL "Owner"		    // Owner
#define _PLATFORM "Platform"                     			    // Platform
#define _LAT 0                                // Latitude
#define _LON 0                                // Longitude
